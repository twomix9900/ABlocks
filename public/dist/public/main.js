...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent.prototype.init = function () {
        for (var row = 0; row <= this._rowCount; row++) {
            ...
            if (row !== this._rowCount) {
                for (var col = 0; col < this._blocksPerRow; col++) {
                    tempRow.push(1);
                }
            }
            else {
                for (var col = 0; col < this._lastRow; col++) {
                    tempRow.push(1);
                }
            }
            if (tempRow.length !== 0) {
    ...
    AppComponent.prototype.toggle = function (x, y) {
...
module.exports = __webpack_require__(/*! /Users/Kay/Desktop/Wee/Misc/evvemi/public/src/main.ts */"./src/main.ts");
